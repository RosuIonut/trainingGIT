...
export ROOTFS_A3=/opt/a3/rootfs
export CROSS_COMPILE=/opt/a3/freescale/usr/local/gcc-4.4.4-glibc-2.11.1-multilib-1.0/arm-fsl-linux-gnueabi/bin/arm-fsl-linux-gnueabi-
export CROSS_ROOTFS=${ROOTFS_A3}
...
QTPATH=${ROOTFS_A3}/usr/local/Qt 

${QTPATH}/bin/qmake -o - "PLATFORM=a3" navi_drawer.pro -spec ${QTPATH}/mkspecs/default | \
sed \
